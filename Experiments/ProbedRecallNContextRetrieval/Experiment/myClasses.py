...
class Trial(object):
    ...
    def getSaveString(self):
        ...
        output_line += '{}\t'.format(self.response)
    ...
    def getResponse(self, recorder):
        ...
        self.response = mouse_overed_candidate
...
class ProbedRecallTrial(Trial):
    ...
    def createProbe(self, serial_position):
        probe_type = 'order'
        stimulus = Stimulus(serial_position * -1, self.exp_parameters)
        
        self.probe = Probe(probe_type, serial_position, stimulus)
...
class ContextRecallTrial(Trial):
    ...
    def createProbe(self, serial_position):
        probe_type = 'item'
        self.probe = Probe(probe_type, serial_position, self.stimulus[serial_position-1])
